...
var messagesVI = map[string]string{
	...
	"ask_install_docker_desc":           "Tải và cài Docker từ get.docker.com (có thể mất vài phút)",
	"yes_install":                       "Có, cài Docker",
	"no_manual":                         "Không, tôi sẽ tự cài",
	"installing_docker":                 "Đang cài đặt Docker...",
	"docker_install_in_progress_note":   "Dùng script cài chính thức từ get.docker.com. Quá trình có thể mất vài phút.",
	...
	"docker_sudo_fallback_note":         "Docker sẽ dùng sudo cho lệnh kk này. Trước kk start, chạy: export KK_DOCKER_SUDO=1 (hoặc đăng xuất/đăng nhập lại).",
	"docker_session_relogin_title":      "Cần đăng nhập lại để dùng nhóm docker",
	"docker_session_relogin_suggestion": "Đăng xuất và đăng nhập lại, hoặc ngắt/kết nối lại SSH, rồi chạy lại kk init.",
	"docker_session_relogin_command":    "Kết nối lại SSH, rồi chạy kk init",
...
`,
  ...
  2. Chạy: kk start`,
	...
	"selfupdate_npm_hint":   "npm install -g @kkauto/kkcli@latest",
	...
	"warn_docker_permissions_fix_failed": "Không sửa được quyền Docker: %v",
	"warn_docker_group_add_failed":       "Không thêm user vào nhóm docker: %v",
	...
	"docker_sudo_password_hint":                   "Nhập mật khẩu sudo khi được hỏi (thường chỉ một lần).",
