...
`,
  ...
  2. Run: kk start`,
	...
	"warn_docker_permissions_fix_failed": "Warning: failed to fix Docker permissions: %v",
	"warn_docker_group_add_failed":       "Warning: failed to add user to docker group: %v",
