...
var messagesEN = map[string]string{
	...
	"docker_sudo_fallback_note":         "Docker will use sudo for this kk command. Before kk start, run: export KK_DOCKER_SUDO=1 (or log out and back in).",
	"docker_session_relogin_title":      "Docker Group Access Requires a New Login",
	"docker_session_relogin_suggestion": "Log out and log back in, or disconnect and reconnect SSH, then run kk init again.",
	"docker_session_relogin_command":    "Reconnect SSH, then run kk init",
