...
- [ ] Update Phase 01: Replace survey/promptui with huh (bubbletea) in code examples
- [ ] Update Phase 01: Add .bak backup logic to init command
- [ ] Update Phase 02: Add .env permission warning (not auto-fix)
- [ ] Update Phase 02: Add Compose version check (require v2.0+)
- [ ] Update Phase 03: Implement compose command detection (v2 fallback v1)
- [ ] Update Distribution: Remove darwin-* targets, keep only linux-amd64 and linux-arm64
